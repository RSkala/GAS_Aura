...
// Health change delegates
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnHealthChangedSignature, float, NewHealth);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnMaxHealthChangedSignature, float, NewMaxHealth);

// Mana change delegates
...
protected:
	...
	void ManaChanged(const struct FOnAttributeChangeData& AttributeChangeData) const;
	void MaxManaChanged(const struct FOnAttributeChangeData& AttributeChangeData) const;
